...
public class Application1 {
    ...
    public static void main(String[] args) {
        ...
        /* 2. 문자 형태의 값 출력*/
        System.out.println('a'); // 문자 형태의 값은 홀때옴표로 감싸주어야 한다.
...
//        System.out.println(''); // 아무 문자로 기록되지 않는 경우도 에러가 발생한다.
        ...
        /* 3. 문자열 형태의 값 출력 */
        System.out.println("안녕하세요"); // 문자열로 문자 여러개가 나열된 형태를 말하며 쌍타옴표로 감싸주어야 한다.
        System.out.println("123"); // 정수 이지만 쌍타옴표로 감싸져 있기 때문에 문자열로 보아야한다.
