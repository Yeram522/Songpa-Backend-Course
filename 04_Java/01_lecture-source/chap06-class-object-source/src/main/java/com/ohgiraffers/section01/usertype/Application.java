...
public class Application {
    public static void main(String[] args) {
        ...
        /* 지금까지 자비에서 제공되는 자료들을 취급하는 자료형에 대해 학습했다.
        ...
        *  사용자 정의의 자료형인 클래스를 이용하기 위해서는 new 연산자로 heap 메모리 공간에 할당을 해야 한다.
        ...
        *  heap에 생상되기 때문에 jvm 기본값으로 초기화 된다.
        * */
