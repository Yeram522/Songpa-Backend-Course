...
public class A_for {
    ...
    public  void printSimpleGugudan(){
        ...
        * */
        ...
        Scanner sc = new Scanner(System.in);
        System.out.print("출력한 구구단의 단 수를 입력하세요 :");
        int dan = sc.nextInt();
